...
VINCLUDE = -I${RTL_DIR} -I${LOCAL_PRIMITIVES} -I${LOCAL_MODULES_OOOEX} -I${LOCAL_MODULES_RENAME} -I${COMMON_CELLS_DIR} ${DEP_FILES}
...
lint:
	${VERILATOR} --lint-only -Wall ${VERILATOR_CENTRAL_WARNINGSBYPASS} --top-module ${TOP_MODULE} ${LOCAL_MODULES_OOOEX}/OoO_packages.pkg ${RTL_DIR}/${TOP_MODULE}.sv ${VINCLUDE} ${MACROS} ${VERILATOR_LOCAL_WARNINGSBYPASS} 
