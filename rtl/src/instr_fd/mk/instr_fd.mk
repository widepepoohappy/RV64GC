...
VINCLUDE = -I${RTL_DIR} -I${LOCAL_PRIMITIVES} -I${LOCAL_MODULES_OOOEX} -I${LOCAL_MODULES_RENAME} -I${LOCAL_MODULES_DECODE} -I${COMMON_CELLS_DIR} -I${LOCAL_MODULES_FETCH} 

PKG_FILES = -I${OOO_PKGS} ${LOCAL_MODULES_DECODE}/dcd_packages.sv
VERILATOR_LOCAL_WARNINGSBYPASS = --waiver-multiline waiver_build_prf_waivers waiver_build_dep_files waiver_build_pt1.txt
...
lint:
	...
	@echo "  Warnings bypass:             ${VERILATOR_CENTRAL_WARNINGSBYPASS}"
...
bypass:
	...
	${VERILATOR} --lint-only -Wall \
	    ...
	    ${DEP_FILES} \
	    ${MACROS} \
	    ${VERILATOR_LOCAL_WARNINGSBYPASS} --waiver-output waiver_build_pt1.txt
